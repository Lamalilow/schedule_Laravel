            ...
            <div class="col-5">
                <form method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="orderStatus" name="role_id" class="form-select @error('role_id') is-invalid @enderror" aria-label="Default select example">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="orderStatus" name="group_id" class="form-select @error('group_id') is-invalid @enderror" aria-label="Default select example">
